...
def run_pipeline(train_path='assets/train.csv', test_path='assets/test.csv'):
    ...
    # Add CatBoost OOF to stacking features
    X_train_stacking['cat_oof'] = cat_oof
    X_test_stacking['cat_oof'] = cat_test_pred_mean
    print("CatBoost OOF predictions added to stacking features.")

    # ---- Stacking: Ridge + LightGBM base models, CatBoost OOF as feature ----
    estimators = [
        ('ridge', ridge_final),
        ('lgb', lgb_final)
    ]
